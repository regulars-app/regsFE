...
import SurpriseSubjectPreferences from '../subScreens/SurpriseSubjectPreferences';


const UpcomingSurpriseEvent = ({subject}) => {

  const tabs = [
    { title: 'Plans', path: 'plans' },
    { title: 'Discussion', path: 'discussion' },
    { title: subject, path: 'subjectPreferences' },
  ];
...
export default UpcomingSurpriseEvent;
